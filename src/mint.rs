...
impl Contract {
    ...
    pub fn nft_mint(
        ...
        } else if amount == 11000000000000000000000000 {
        ...
        royalty.insert("tipjargon.near".to_string().try_into().unwrap(), 300);
        ...
        self.token_metadata_by_id.insert(&token_id, &TokenMetadata{
            title: Some("Dungeon Goblin #".to_owned() + token_id.as_ref()),
            description: Some("Dungeon Goblins is a generative NFT series that is paired with a generative musical composition.".to_owned()),
